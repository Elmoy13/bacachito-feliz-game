...
export const precopeoChallenges: Challenge[] = [
  ...
  { id: 'pre-t8', type: 'timed', template: 'Todos deben terminar las frases con "{{dude}}"', subtitle: 'Por 90 segundos. El que olvide: trago', duration: 90 },
  ...
  { id: 'pre-45', type: 'extreme', template: 'LOS QUE LLEGARON TARDE', subtitle: 'Los últimos 2 en llegar a la {{party}}: fondo.', isExtreme: true },
  ...
  { id: 'pre-51', type: 'extreme', template: 'ROUND DE CALENTAMIENTO', subtitle: 'Todos toman un shot. Sin excusas. Es el {{pregame}}.', isExtreme: true },
...
export const pedaChallenges: Challenge[] = [
  ...
  { id: 'peda-10', type: 'direct', template: '{player}, ¿quién del grupo te cae menos?', subtitle: 'No seas {{lame}}. Y tómense un shot juntos.' },
  ...
  { id: 'peda-36b', type: 'vote', template: '¿Quién sería el peor compañero de {{party}}?', subtitle: 'El aguafiestas: shot.' },
  ...
  { id: 'peda-43e', type: 'random', template: '{player}, envía un audio de voz a tu grupo familiar.', subtitle: 'Diciendo que estás {{drunk}}. Si no: shot doble.' },
  ...
  { id: 'peda-t4', type: 'timed', template: '{player}, debes terminar todo con "{{dude}}"', subtitle: 'Por 1 minuto. Si no lo haces: trago', duration: 60 },
...
export const randomMixChallenges: Challenge[] = [
  ...
  { id: 'mix-42', type: 'extreme', template: 'FLASHBACK', subtitle: 'Recuerden algo vergonzoso que hayan hecho en una {{party}}. Cuéntenlo o shot.', isExtreme: true },
...
export const fiestaChallenges: Challenge[] = [
  ...
  { id: 'fiesta-3', type: 'group', template: 'Señalen al más {{drunk}}.', subtitle: 'El ganador toma 2 más para seguir ganando.' },
  ...
  { id: 'fiesta-8', type: 'group', template: 'Señalen al organizador de la {{party}}.', subtitle: 'Reparte 5 tragos por el esfuerzo.' },
  ...
  { id: 'fiesta-15b', type: 'group', template: 'Señalen al que más se ha {{drunk}} este año.', subtitle: 'El campeón: shot de honor.' },
  ...
  { id: 'fiesta-44', type: 'extreme', template: 'RONDA DE HONOR', subtitle: 'Los que nunca hayan vomitado en una {{party}}: shot de suerte.', isExtreme: true },
